...
pub fn all_commands() -> Vec<Command> {
    vec![
        Command { name: "New Tab", shortcut: "Cmd+N", id: CommandId::NewTab },
        Command { name: "Open File", shortcut: "Cmd+O", id: CommandId::OpenFile },
        Command { name: "Save", shortcut: "Cmd+S", id: CommandId::Save },
        Command { name: "Save As", shortcut: "Cmd+Shift+S", id: CommandId::SaveAs },
        Command { name: "Close Tab", shortcut: "Cmd+W", id: CommandId::CloseTab },
        Command { name: "Undo", shortcut: "Cmd+Z", id: CommandId::Undo },
        Command { name: "Redo", shortcut: "Cmd+Shift+Z", id: CommandId::Redo },
