...
impl Theme {
    ...
    pub fn solarized_light() -> Self {
        Self {
            ...
            bg: Color::from_hex("#fdf6e3"),
            fg: Color::from_hex("#657b83"),
            gutter_bg: Color::from_hex("#eee8d5"),
            gutter_fg: Color::from_hex("#93a1a1"),
            gutter_active_fg: Color::from_hex("#586e75"),
            cursor: Color::from_hex("#586e75"),
            selection: Color::from_hex("#eee8d5"),
            tab_bar_bg: Color::from_hex("#eee8d5"),
            tab_active_bg: Color::from_hex("#fdf6e3"),
            tab_active_fg: Color::from_hex("#586e75"),
            tab_inactive_bg: Color::from_hex("#e6dfcb"),
            tab_inactive_fg: Color::from_hex("#93a1a1"),
            status_bar_bg: Color::from_hex("#eee8d5"),
            status_bar_fg: Color::from_hex("#586e75"),
            scrollbar_bg: Color::from_hex("#fdf6e300"),
            scrollbar_thumb: Color::from_hex("#93a1a180"),
            syntax_keyword: Color::from_hex("#859900"),
            syntax_string: Color::from_hex("#2aa198"),
            syntax_comment: Color::from_hex("#93a1a1"),
            syntax_function: Color::from_hex("#268bd2"),
            syntax_number: Color::from_hex("#d33682"),
            syntax_type: Color::from_hex("#b58900"),
            syntax_operator: Color::from_hex("#657b83"),
            syntax_variable: Color::from_hex("#cb4b16"),
            find_match: Color::from_hex("#b5890060"),
            find_match_active: Color::from_hex("#b58900a0"),
        }
    }
    ...
    pub fn github_light() -> Self {
        Self {
            ...
            bg: Color::from_hex("#ffffff"),
            fg: Color::from_hex("#24292f"),
            gutter_bg: Color::from_hex("#ffffff"),
            gutter_fg: Color::from_hex("#8c959f"),
            gutter_active_fg: Color::from_hex("#24292f"),
            cursor: Color::from_hex("#0969da"),
            selection: Color::from_hex("#ddf4ff"),
            tab_bar_bg: Color::from_hex("#f6f8fa"),
            tab_active_bg: Color::from_hex("#ffffff"),
            tab_active_fg: Color::from_hex("#24292f"),
            tab_inactive_bg: Color::from_hex("#f6f8fa"),
            tab_inactive_fg: Color::from_hex("#656d76"),
            status_bar_bg: Color::from_hex("#f6f8fa"),
            status_bar_fg: Color::from_hex("#24292f"),
            scrollbar_bg: Color::from_hex("#ffffff00"),
            scrollbar_thumb: Color::from_hex("#8c959f80"),
            syntax_keyword: Color::from_hex("#cf222e"),
            syntax_string: Color::from_hex("#0a3069"),
            syntax_comment: Color::from_hex("#6e7781"),
            syntax_function: Color::from_hex("#8250df"),
            syntax_number: Color::from_hex("#0550ae"),
            syntax_type: Color::from_hex("#953800"),
            syntax_operator: Color::from_hex("#cf222e"),
            syntax_variable: Color::from_hex("#24292f"),
            find_match: Color::from_hex("#fff8c560"),
            find_match_active: Color::from_hex("#fff8c5a0"),
        }
    }
    ...
    pub fn catppuccin_latte() -> Self {
        Self {
            ...
            bg: Color::from_hex("#eff1f5"),
            fg: Color::from_hex("#4c4f69"),
            gutter_bg: Color::from_hex("#e6e9ef"),
            gutter_fg: Color::from_hex("#9ca0b0"),
            gutter_active_fg: Color::from_hex("#4c4f69"),
            cursor: Color::from_hex("#dc8a78"),
            selection: Color::from_hex("#ccd0da"),
            tab_bar_bg: Color::from_hex("#e6e9ef"),
            tab_active_bg: Color::from_hex("#eff1f5"),
            tab_active_fg: Color::from_hex("#4c4f69"),
            tab_inactive_bg: Color::from_hex("#dce0e8"),
            tab_inactive_fg: Color::from_hex("#8c8fa1"),
            status_bar_bg: Color::from_hex("#e6e9ef"),
            status_bar_fg: Color::from_hex("#4c4f69"),
            scrollbar_bg: Color::from_hex("#eff1f500"),
            scrollbar_thumb: Color::from_hex("#9ca0b080"),
            syntax_keyword: Color::from_hex("#8839ef"),
            syntax_string: Color::from_hex("#40a02b"),
            syntax_comment: Color::from_hex("#9ca0b0"),
            syntax_function: Color::from_hex("#1e66f5"),
            syntax_number: Color::from_hex("#fe640b"),
            syntax_type: Color::from_hex("#df8e1d"),
            syntax_operator: Color::from_hex("#04a5e5"),
            syntax_variable: Color::from_hex("#e64553"),
            find_match: Color::from_hex("#df8e1d60"),
            find_match_active: Color::from_hex("#df8e1da0"),
        }
    }
