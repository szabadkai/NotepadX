...
impl Theme {
    ...
    pub fn catppuccin_mocha() -> Self {
        Self {
            ...
            gutter_fg: Color::from_hex("#585b70"),
            ...
            tab_inactive_fg: Color::from_hex("#6c7086"),
    ...
    pub fn one_dark() -> Self {
        Self {
            ...
            gutter_fg: Color::from_hex("#4b5263"),
            ...
            tab_inactive_fg: Color::from_hex("#5c6370"),
    ...
    pub fn monokai() -> Self {
        Self {
            ...
            gutter_fg: Color::from_hex("#90908a"),
            ...
            tab_inactive_fg: Color::from_hex("#75715e"),
    ...
    pub fn nord() -> Self {
        Self {
            ...
            gutter_fg: Color::from_hex("#4c566a"),
            ...
            tab_inactive_fg: Color::from_hex("#4c566a"),
    ...
    pub fn dracula() -> Self {
        Self {
            ...
            gutter_fg: Color::from_hex("#6272a4"),
            gutter_active_fg: Color::from_hex("#f8f8f2"),
            ...
            tab_inactive_fg: Color::from_hex("#6272a4"),
