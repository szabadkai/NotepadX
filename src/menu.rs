use muda::{Menu, Submenu, MenuItem, PredefinedMenuItem, AboutMetadata, MenuId, MenuEvent};
...
impl AppMenu {
    pub fn new() -> Self {
        ...
        let palette_item = MenuItem::with_id(
            ...
            "Command Palette", 
            true, 
            Some(Accelerator::new(Some(Modifiers::SUPER | Modifiers::SHIFT), Code::KeyP))
        );
        ...
        #[cfg(target_os = "macos")]
        {
            ...
            let _ = app_menu.append(&PredefinedMenuItem::about(Some("About NotepadX"), Some(about_metadata)));
